    ...
    render() {
        return (
            <div className="mentions-legales">
                ...
                site de l'hébergeur : https://www.ovh.com/fr/<br/>
                Numéro de déclaration du site internet à la CNIL: NCH1857831G<br/>
                L’association UN MUR DANS LE RÉEL informe les utilisateurs du site internet que les informations qu’ils
                fournissent ne seront pas utilisées à des fins commerciales.
                ...
                en écrivant à l'adresse suivante : Association Un Mur Dans le Réel - 22 chemin du coin de la Moure -
                appt 25 - 31500 Toulouse

                <h3>Cookies</h3>

                Notre site est conçu pour être attentif aux besoins de ses utilisateurs. C'est notamment pour cela que
                nous faisons usage de cookies. Ils ont pour but d'enregistrer le parcours de l'utilisateur dans le site
                ou les pages les plus fréquentées, ce qui permet de réaliser des statistiques de consultation (nombre de
                visites, type de navigateur...). Les cookies permettent d'optimiser notre site en terme de navigation
                mais ces informations ne sont en aucun cas transmises à des tiers. Les cookies ne contiennent aucune
                information personnelle concernant l'utilisateur et ne permettent pas de l'identifier. Il est possible
                de supprimer les cookies ou de demander à votre navigateur de vous en signaler la présence.


                <h3>Propriété intellectuelle</h3>

                Article L122-4 du Code de la Propriété intellectuelle : " Toute représentation ou reproduction intégrale
                ...
                promptement pour les retirer dès qu'il en a eu connaissance”.
